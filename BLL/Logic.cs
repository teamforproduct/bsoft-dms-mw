...
namespace BLL
{
    public static class Logic
    {
        ...
        public static void GetDocument1()
        {
            string query = "BSOFT_DOB.DOB_CATALOGS.GET_TPD_CAT";
            ...
            using (OracleConnection con = new OracleConnection(ConfigurationManager.ConnectionStrings["EntitiesBSOFT_DOB"].ConnectionString))
            {
                ...
                var p1 = cmd.Parameters.Add("Result", OracleDbType.RefCursor, ParameterDirection.ReturnValue);
                //var jsontext = cmd.Parameters.Add("p_jsn_str", OracleDbType.Clob);
                //jsontext.Value = "{\"CRT\" : {},\"LIM\" : {\"START\" : 0, \"LENGTH\" : 1}}";
