namespace BL.Model.Constants
{
    public static class SettingConstants
    {
        ...
        public static string CRYPTO_LOCAL_SIGNDATA_KEY_NAME = @"CRYPTO_LOCAL_SIGNDATA_KEY_NAME";
        public static string CRYPTO_OBTAINED_PUBLIC_KEY_NAME_FOR_VERIFY_SIGNED_HASH = @"CRYPTO_OBTAINED_PUBLIC_KEY_NAME_FOR_VERIFY_SIGNED_HASH";
    }
}