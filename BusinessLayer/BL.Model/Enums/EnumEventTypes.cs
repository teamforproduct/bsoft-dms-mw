namespace BL.Model.Enums
{
    public enum EnumEventTypes
    {
        ...
        // TODO В наименовании констант нужно использовать латинские символы!!!
        ПоступилВходящийДокумент = 100,
        ОчереднойСрокИсполнения = 450,
        ИстекаетСрокИсполнения = 460,
        СрокИсполненияИстек = 470,
        НаправленоСообщение = 500,
        ДобавленБумажныйНоситель = 505,
        ОтметкаНахожденияБумажногоНосителяУСебя = 507,
        ОтметкаПорчиБумажногоНосителя = 509,
        ПереданыБумажныеНосители = 510,
        Примечание = 600,
        ФормулировкаЗадачи = 601,
        ПереданНаРассмотрениеРуководителю = 610,
        ПолученПослеРассмотренияРуководителем = 620,
        НаправленНаРегистрацию = 700,
        Зарегистрирован = 701,
        ОтказаноВРегистрации = 702,
        ОтозванПроект = 712,
        ЗапущеноИсполнениеПланаРаботыПоДокументу = 800,
        ОстановленоИсполнениеПланаРаботыПоДокументу = 810,
        РаботаВозобновлена = 998,
        РаботаЗавершена = 999,
