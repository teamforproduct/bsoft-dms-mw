...
namespace BL.Database.Helper
{
    public class ConnectionHelper : IConnectionHelper
    {
        ...
        public static DbConnection GetDefaultConnection()
        {
            ...
            //return new SqlConnection(@"Data Source=192.168.0.222\SQLEXPRESS;Initial Catalog=PROD_IRF_DMS_WEBAPI;User ID=bsoft;Password=TME3ZAf2MMqsPY;Application Name=EntityFramework");
