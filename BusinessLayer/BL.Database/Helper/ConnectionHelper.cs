...
namespace BL.Database.Helper
{
    public class ConnectionHelper : IConnectionHelper
    {
        ...
        public static DbConnection GetDefaultConnection()
        {
            ...
            return new SqlConnection(@"Data Source=194.247.18.39,1433\SQLEXPRESS;Initial Catalog=PROD_IRF_DMS;User ID=bsoft;Password=TME3ZAf2MMqsPY;Application Name=EntityFramework;Connection Timeout=3600");
