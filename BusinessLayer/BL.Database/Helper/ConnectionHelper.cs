...
namespace BL.Database.Helper
{
    public class ConnectionHelper : IConnectionHelper
    {
        ...
        public static DbConnection GetDefaultConnection()
        {
            ...
            return new SqlConnection(@"Data Source=10.88.12.22,1433\SQLEXPRESS;Initial Catalog=PROD_IRF_DMS_NEW;User ID=bsoft;Password=TME3ZAf2MMqsPY;Application Name=EntityFramework");
