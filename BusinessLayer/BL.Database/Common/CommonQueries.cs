...
namespace BL.Database.Common
{
    internal static class CommonQueries
    {
        ...
        public static void SetSuccessfulSubscriptions(IContext context, InternalDocument doc)
        {
            var dbContext = context.DbContext as DmsContext;
            if (doc == null) return;
                ...
                {
                    {
                        ...
                        qry = qry.Where(x => !x.OffEventId.HasValue && (x.OnEvent.EventTypeId == (int)EnumEventTypes.SendForExecution || x.OnEvent.EventTypeId == (int)EnumEventTypes.SendForExecutionChange))
        ...
        public static IEnumerable<FrontPropertyValue> GetPropertyValues(IContext context, FilterPropertyValue filter)
        {
            ...
            var itemsRes = itemsDb
                .Select(x => new
                {
                    ...
                    PropertyValueTypeCode = ((EnumValueTypes)x.PropertyLink.Property.ValueTypeId).ToString(),
        ...
        private static string GetStringDocumentForDocumentHash(InternalDocument doc, bool isFull = false)
        {
            ...
            if (doc.SendLists?.Count() > 0)
            {
                ...
                {
                    stringDocument.Append(docSendList.Id);//TODO multitargets
