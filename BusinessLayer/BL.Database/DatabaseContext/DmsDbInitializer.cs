...
namespace BL.Database.DatabaseContext
{
    public class DmsDbInitializer : CreateDatabaseIfNotExists<DmsContext>
    {
        ...
        private void AddALV(List<AdminLanguageValues> list, string label, string EngLang, string RusLang)
        {
        ...
        private SystemActions GetSysAct(EnumAdminActions id, EnumObjects objId, string description, string category = null,  bool isGrantable = false, bool isGrantableByRecordId = false, bool isVisible = false, int? grantId = null)
        { return GetSystemAction((int)id, id.ToString(), objId, description, category, isGrantable, isGrantableByRecordId, isVisible, grantId); }

        private SystemActions GetSysAct(EnumEncryptionActions id, EnumObjects objId, string description, string category = null, bool isGrantable = false, bool isGrantableByRecordId = false, bool isVisible = false, int? grantId = null)
        { return GetSystemAction((int)id, id.ToString(), objId, description, category, isGrantable, isGrantableByRecordId, isVisible, grantId); }

        private SystemActions GetSysAct(EnumPropertyAction id, EnumObjects objId, string description, string category = null, bool isGrantable = false, bool isGrantableByRecordId = false, bool isVisible = false, int? grantId = null)
        { return GetSystemAction((int)id, id.ToString(), objId, description, category, isGrantable, isGrantableByRecordId, isVisible, grantId); }

        private SystemActions GetSysAct(EnumDictionaryActions id, EnumObjects objId, string description, string category = null, bool isGrantable = false, bool isGrantableByRecordId = false, bool isVisible = false, int? grantId = null)
        { return GetSystemAction((int)id, id.ToString(), objId, description, category, isGrantable, isGrantableByRecordId, isVisible, grantId); }

        private SystemActions GetSysAct(EnumDocumentActions id, EnumObjects objId, string description, string category = null, bool isGrantable = false, bool isGrantableByRecordId = false, bool isVisible = false, int? grantId = null)
        { return GetSystemAction((int)id, id.ToString(), objId, description, category, isGrantable, isGrantableByRecordId, isVisible, grantId); }

        private SystemActions GetSystemAction(int id, string code, EnumObjects objId, string description, string category = null, bool isGrantable = false, bool isGrantableByRecordId = false, bool isVisible = false, int? grantId = null)
        {
