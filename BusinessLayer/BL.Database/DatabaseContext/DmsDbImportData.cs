...
namespace BL.Database.DatabaseContext
{
    public static class DmsDbImportData
    {
        ...
        public static List<SystemActions> GetSystemActions()
        {
            ...
            items.Add(GetSysAct(EnumDocumentActions.LaunchPlan, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Info, EnumAccessTypes.U), category: "Действия"));
            items.Add(GetSysAct(EnumDocumentActions.AddDocumentSendListItem, EnumObjects.Documents, category: "Действия"));
            items.Add(GetSysAct(EnumDocumentActions.StopPlan, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Info, EnumAccessTypes.U), category: "Действия"));
            items.Add(GetSysAct(EnumDocumentActions.ChangeExecutor, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Info, EnumAccessTypes.U), category: "Действия"));
            items.Add(GetSysAct(EnumDocumentActions.RegisterDocument, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Info, EnumAccessTypes.C), category: "Действия"));
            ...
            items.Add(GetSysAct(EnumDocumentActions.ReportRegistrationCardDocument, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Info, EnumAccessTypes.R), category: "Документ"));
            items.Add(GetSysAct(EnumDocumentActions.ReportRegisterTransmissionDocuments, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Info, EnumAccessTypes.R), category: "Отчеты"));
            items.Add(GetSysAct(EnumDocumentActions.ReportDocumentForDigitalSignature, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Info, EnumAccessTypes.R), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.AddFavourite, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Favourite, EnumAccessTypes.C), category: "Дополнительно", isGrantable: false));
            items.Add(GetSysAct(EnumDocumentActions.DeleteFavourite, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Favourite, EnumAccessTypes.D), category: "Дополнительно", isGrantable: false));
            items.Add(GetSysAct(EnumDocumentActions.FinishWork, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Info, EnumAccessTypes.U), category: "Дополнительно", isGrantable: false));
            items.Add(GetSysAct(EnumDocumentActions.StartWork, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Info, EnumAccessTypes.U), category: "Дополнительно", isGrantable: false));
            ...
            items.Add(GetSysAct(EnumDocumentActions.AddDocumentRestrictedSendList, EnumObjects.DocumentRestrictedSendLists, GetPermissionId(Modules.Document, Features.AccessList, EnumAccessTypes.C)));
            items.Add(GetSysAct(EnumDocumentActions.AddByStandartSendListDocumentRestrictedSendList, EnumObjects.DocumentRestrictedSendLists, GetPermissionId(Modules.Document, Features.AccessList, EnumAccessTypes.C)));
            items.Add(GetSysAct(EnumDocumentActions.DeleteDocumentRestrictedSendList, EnumObjects.DocumentRestrictedSendLists, GetPermissionId(Modules.Document, Features.AccessList, EnumAccessTypes.D)));

            items.Add(GetSysAct(EnumDocumentActions.AddDocumentSendList, EnumObjects.DocumentSendListStages, GetPermissionId(Modules.Document, Features.Plan, EnumAccessTypes.C)));
            ...
            items.Add(GetSysAct(EnumDocumentActions.ModifyDocumentSendList, EnumObjects.DocumentSendLists, GetPermissionId(Modules.Document, Features.Plan, EnumAccessTypes.U)));
            items.Add(GetSysAct(EnumDocumentActions.DeleteDocumentSendList, EnumObjects.DocumentSendLists, GetPermissionId(Modules.Document, Features.Plan, EnumAccessTypes.D)));
            items.Add(GetSysAct(EnumDocumentActions.CopyDocumentSendList, EnumObjects.DocumentSendLists, GetPermissionId(Modules.Document, Features.Plan, EnumAccessTypes.C), isVisibleInMenu: false));
            items.Add(GetSysAct(EnumDocumentActions.LaunchDocumentSendListItem, EnumObjects.DocumentSendLists, GetPermissionId(Modules.Document, Features.Plan, EnumAccessTypes.U)));

            items.Add(GetSysAct(EnumDocumentActions.AddDocumentFile, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.C)));
            items.Add(GetSysAct(EnumDocumentActions.ModifyDocumentFile, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.U)));
            items.Add(GetSysAct(EnumDocumentActions.DeleteDocumentFile, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.D)));
            items.Add(GetSysAct(EnumDocumentActions.AddDocumentFileUseMainNameFile, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.C)));
            items.Add(GetSysAct(EnumDocumentActions.AcceptDocumentFile, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.U)));
            items.Add(GetSysAct(EnumDocumentActions.RejectDocumentFile, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.U)));
            items.Add(GetSysAct(EnumDocumentActions.RenameDocumentFile, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.U)));
            items.Add(GetSysAct(EnumDocumentActions.DeleteDocumentFileVersion, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.D)));
            items.Add(GetSysAct(EnumDocumentActions.DeleteDocumentFileVersionRecord, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.D)));
            items.Add(GetSysAct(EnumDocumentActions.AcceptMainVersionDocumentFile, EnumObjects.DocumentFiles, GetPermissionId(Modules.Document, Features.Files, EnumAccessTypes.U)));

            items.Add(GetSysAct(EnumDocumentActions.AddDocumentLink, EnumObjects.DocumentLinks, GetPermissionId(Modules.Document, Features.Links, EnumAccessTypes.C)));
            items.Add(GetSysAct(EnumDocumentActions.DeleteDocumentLink, EnumObjects.DocumentLinks, GetPermissionId(Modules.Document, Features.Links, EnumAccessTypes.U)));

            items.Add(GetSysAct(EnumDocumentActions.SendDocument, EnumObjects.Documents, GetPermissionId(Modules.Document, Features.Events, EnumAccessTypes.C), category: "Действия"));
            items.Add(GetSysAct(EnumDocumentActions.SendMessage, EnumObjects.DocumentEvents, GetPermissionId(Modules.Document, Features.Events, EnumAccessTypes.C), category: "Информирование", isGrantable: false));
            items.Add(GetSysAct(EnumDocumentActions.AddNote, EnumObjects.DocumentEvents, GetPermissionId(Modules.Document, Features.Events, EnumAccessTypes.C), category: "Информирование", isGrantable: false));
            items.Add(GetSysAct(EnumDocumentActions.ControlOn, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.C), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.ControlChange, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.U), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.SendForExecutionChange, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.U), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.SendForResponsibleExecutionChange, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.U), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.ControlTargetChange, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.U), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.ControlOff, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.U), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.AskPostponeDueDate, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.C), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.CancelPostponeDueDate, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.U), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.MarkExecution, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.C), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.AcceptResult, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.U), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.CancelExecution, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.U), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.RejectResult, EnumObjects.DocumentWaits, GetPermissionId(Modules.Document, Features.Waits, EnumAccessTypes.U), category: "Контроль"));
            items.Add(GetSysAct(EnumDocumentActions.WithdrawVisaing, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.WithdrawАgreement, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.WithdrawАpproval, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.WithdrawSigning, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.AffixVisaing, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.AffixАgreement, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.AffixАpproval, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.AffixSigning, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.SelfAffixSigning, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание", isVisibleInMenu: false));
            items.Add(GetSysAct(EnumDocumentActions.RejectVisaing, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.RejectАgreement, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.RejectАpproval, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.RejectSigning, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));
            items.Add(GetSysAct(EnumDocumentActions.VerifySigning, EnumObjects.DocumentSubscriptions, GetPermissionId(Modules.Document, Features.Signs, EnumAccessTypes.U), category: "Подписание"));

            items.Add(GetSysAct(EnumDocumentActions.AddDocumentTask, EnumObjects.DocumentTasks, GetPermissionId(Modules.Document, Features.Tasks, EnumAccessTypes.C)));
            items.Add(GetSysAct(EnumDocumentActions.ModifyDocumentTask, EnumObjects.DocumentTasks, GetPermissionId(Modules.Document, Features.Tasks, EnumAccessTypes.U)));
            items.Add(GetSysAct(EnumDocumentActions.DeleteDocumentTask, EnumObjects.DocumentTasks, GetPermissionId(Modules.Document, Features.Tasks, EnumAccessTypes.D)));

            items.Add(GetSysAct(EnumDocumentActions.AddDocumentPaper, EnumObjects.DocumentPapers, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.C), category: "Бумажные носители"));
            items.Add(GetSysAct(EnumDocumentActions.ModifyDocumentPaper, EnumObjects.DocumentPapers, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.U), category: "Бумажные носители"));
            items.Add(GetSysAct(EnumDocumentActions.MarkOwnerDocumentPaper, EnumObjects.DocumentPapers, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.D), category: "Бумажные носители"));
            items.Add(GetSysAct(EnumDocumentActions.MarkСorruptionDocumentPaper, EnumObjects.DocumentPapers, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.U), category: "Бумажные носители"));
            items.Add(GetSysAct(EnumDocumentActions.DeleteDocumentPaper, EnumObjects.DocumentPapers, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.U), category: "Бумажные носители"));
            items.Add(GetSysAct(EnumDocumentActions.PlanDocumentPaperEvent, EnumObjects.DocumentPaperEvents, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.U), category: "Бумажные носители"));
            items.Add(GetSysAct(EnumDocumentActions.CancelPlanDocumentPaperEvent, EnumObjects.DocumentPaperEvents, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.U), category: "Бумажные носители"));
            items.Add(GetSysAct(EnumDocumentActions.SendDocumentPaperEvent, EnumObjects.DocumentPaperEvents, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.U), category: "Бумажные носители"));
            items.Add(GetSysAct(EnumDocumentActions.CancelSendDocumentPaperEvent, EnumObjects.DocumentPaperEvents, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.U), category: "Бумажные носители"));
            items.Add(GetSysAct(EnumDocumentActions.RecieveDocumentPaperEvent, EnumObjects.DocumentPaperEvents, GetPermissionId(Modules.Document, Features.Papers, EnumAccessTypes.U), category: "Бумажные носители"));
            ...
            items.Add(GetSysAct(EnumDocumentActions.AddSavedFilter, EnumObjects.DocumentSavedFilters, GetPermissionId(Modules.Document, Features.SavedFilters, EnumAccessTypes.C)));
            items.Add(GetSysAct(EnumDocumentActions.ModifySavedFilter, EnumObjects.DocumentSavedFilters, GetPermissionId(Modules.Document, Features.SavedFilters, EnumAccessTypes.U)));
            items.Add(GetSysAct(EnumDocumentActions.DeleteSavedFilter, EnumObjects.DocumentSavedFilters, GetPermissionId(Modules.Document, Features.SavedFilters, EnumAccessTypes.D)));
            items.Add(GetSysAct(EnumDocumentActions.ModifyDocumentTags, EnumObjects.DocumentTags, GetPermissionId(Modules.Document, Features.Tags, EnumAccessTypes.C)));
