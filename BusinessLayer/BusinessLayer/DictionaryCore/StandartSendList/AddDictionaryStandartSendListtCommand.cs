...
namespace BL.Logic.DictionaryCore.StandartSendList
{
    public class AddDictionaryStandartSendListCommand : BaseDictionaryCommand
    {
        ...
        public override bool CanExecute()
        {
            ...
            var spr = _dictDb.GetDictionaryStandartSendLists(_context, new FilterDictionaryStandartSendList
            {
               Name = Model.Name,
        ...
        public override object Execute()
        {
            try
            {
                ...
                return _dictDb.AddDictionaryStandartSendList(_context, newList);
            }
            catch (Exception ex)
            {
