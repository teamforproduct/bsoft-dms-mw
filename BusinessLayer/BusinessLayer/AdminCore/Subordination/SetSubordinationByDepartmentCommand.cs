...
namespace BL.Logic.AdminCore
{
    ...
    {
        private SetSubordinationByDepartment Model
        {
            get
            {
                if (!(_param is SetSubordinationByDepartment)) throw new WrongParameterTypeError();
                return (SetSubordinationByDepartment)_param;
            }
        }
