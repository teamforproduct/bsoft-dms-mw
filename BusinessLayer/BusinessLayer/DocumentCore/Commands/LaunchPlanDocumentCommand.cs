...
namespace BL.Logic.DocumentCore.Commands
{
    public class LaunchPlanDocumentCommand : BaseDocumentCommand
    {
        ...
        public override bool CanBeDisplayed()
        {
            ...
            try
            {
                _adminDb.VerifyAccess(_context, new VerifyAccess { DocumentActionCode = EnumDocumentActions.LaunchPlan, PositionId = _context.CurrentPositionId });
        ...
        public override object Execute()
        {
            ...
            _documentDb.LaunchPlanDocument(_context, Model);

            return Model;
        }

        public override EnumDocumentActions CommandType { get { return EnumDocumentActions.LaunchPlan; } }
    }
}