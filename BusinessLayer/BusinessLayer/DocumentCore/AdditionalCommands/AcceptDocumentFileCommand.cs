...
namespace BL.Logic.DocumentCore.AdditionalCommands
{
    public class AcceptDocumentFileCommand : BaseDocumentCommand
    {
        ...
        public override object Execute()
        {
            ...
            _file.Events = CommonDocumentUtilities.GetNewDocumentEvents(_context, _file.EntityId, EnumEventTypes.AcceptDocumentFile, null, _file.Name + "." + _file.Extension, null, null, false, _file.ExecutorPositionId);
