...
namespace BL.Logic.DocumentCore.AdditionalCommands
{
    public class DeleteDocumentFileCommand : BaseDocumentCommand
    {
        ...
        public override object Execute()
        {
            ...
            {
                docFile.Events = CommonDocumentUtilities.GetNewDocumentEvents(_context, (int)EnumEntytiTypes.Document, docFile.DocumentId, EnumEventTypes.DeleteDocumentFile, null, null, _file.File.Name + "." + _file.File.Extension);
            }
