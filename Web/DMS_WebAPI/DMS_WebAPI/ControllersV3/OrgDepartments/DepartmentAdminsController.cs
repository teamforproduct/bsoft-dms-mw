...
namespace DMS_WebAPI.ControllersV3.OrgDepartments
{
    ...
    public class DepartmentAdminsController : WebApiController
    {
        ...
        public async Task<IHttpActionResult> Post([FromBody]AddAdminDepartmentAdmin model)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                var tmpItem = Action.ExecuteAdminAction(context, EnumActions.AddDepartmentAdmin, model);
        ...
        public async Task<IHttpActionResult> Delete([FromUri] int Id)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                Action.ExecuteAdminAction(context, EnumActions.DeleteDepartmentAdmin, Id);
