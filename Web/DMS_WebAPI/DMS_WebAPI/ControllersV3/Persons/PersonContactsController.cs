...
namespace DMS_WebAPI.ControllersV3.Persons
{
    ...
    public class PersonContactsController : ApiController
    {
        ...
        {
            var tmpItem = Action.Execute(EnumDictionaryActions.AddPersonContact, model);
            return Get(tmpItem);
        }
        ...
        {
            Action.Execute(EnumDictionaryActions.ModifyPersonContact, model);
            return Get(model.Id);
        }
        ...
        {
            Action.Execute(EnumDictionaryActions.DeletePersonContact, Id);
