...
namespace DMS_WebAPI.ControllersV3.Persons
{
    ...
    public class PersonContactsController : WebApiController
    {
        ...
        public async Task<IHttpActionResult> Post([FromBody]AddAgentContact model)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                var tmpItem = Action.ExecuteDictionaryAction(context, EnumActions.AddPersonContact, model);
        ...
        public async Task<IHttpActionResult> Put([FromBody]ModifyAgentContact model)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                Action.ExecuteDictionaryAction(context, EnumActions.ModifyPersonContact, model);
        ...
        public async Task<IHttpActionResult> Delete([FromUri] int Id)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                Action.ExecuteDictionaryAction(context, EnumActions.DeletePersonContact, Id);
