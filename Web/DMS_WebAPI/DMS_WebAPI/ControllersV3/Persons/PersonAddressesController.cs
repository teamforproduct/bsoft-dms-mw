...
{
    /// <summary>
    /// Физические лица. Адреса
    /// </summary>
    [Authorize]
    [DimanicAuthorize]
    [RoutePrefix(ApiPrefix.V3 + Modules.Person)]
    public class PersonAddressesController : WebApiController
    {
        ...
        public async Task<IHttpActionResult> Post([FromBody]AddAgentAddress model)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                var tmpItem = Action.ExecuteDictionaryAction(context, EnumActions.AddPersonAddress, model);
        ...
        public async Task<IHttpActionResult> Put([FromBody]ModifyAgentAddress model)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                Action.ExecuteDictionaryAction(context, EnumActions.ModifyPersonAddress, model);
        ...
        public async Task<IHttpActionResult> Delete([FromUri] int Id)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                Action.ExecuteDictionaryAction(context, EnumActions.DeletePersonAddress, Id);
