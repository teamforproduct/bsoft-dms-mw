...
namespace DMS_WebAPI.ControllersV3.Employees
{
    ...
    public class EmployeeAddressesController : WebApiController
    {
        ...
        public async Task<IHttpActionResult> Post([FromBody]AddAgentAddress model)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                var tmpItem = Action.ExecuteDictionaryAction(context, EnumActions.AddEmployeeAddress, model);
        ...
        public async Task<IHttpActionResult> Put([FromBody]ModifyAgentAddress model)
        {
            return await SafeExecuteAsync(ModelState, (context, param) =>
            {
                Action.ExecuteDictionaryAction(context, EnumActions.ModifyEmployeeAddress, model);
