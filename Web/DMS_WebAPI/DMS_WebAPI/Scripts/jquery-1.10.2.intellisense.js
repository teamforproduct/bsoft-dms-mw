...
intellisense.annotate(jQuery, {
  ...
  'parseHTML': function() {
    ...
    ///   <param name="ctx" type="Element">DOM element to serve as the ctx in which the HTML fragment will be created</param>
  ...
  'proxy': function() {
    ...
    ///   <param name="ctx" type="PlainObject">The object to which the ctx (this) of the function should be set.</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular ctx.</summary>
    ///   <param name="ctx" type="PlainObject">The object to which the ctx of the function should be set.</param>
    ///   <param name="name" type="String">The name of the function whose ctx will be changed (should be a property of the ctx object).</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular ctx.</summary>
...
intellisense.annotate(_object, {
  ...
  'fireWith': function() {
    ...
    ///   <param name="ctx" type="">A reference to the ctx in which the callbacks in the list should be fired.</param>
...
intellisense.annotate(jQuery.fn, {
  'add': function() {
    ...
    ///   <summary>Add elements to the set of matched elements.</summary>
    ///   <param name="selector" type="String">A string representing a selector expression to find additional elements to add to the set of matched elements.</param>
    ///   <param name="ctx" type="Element">The point in the document at which the selector should begin matching; similar to the ctx argument of the $(selector, ctx) method.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'addBack': function() {
  ...
  'closest': function() {
    ...
    ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <param name="ctx" type="Element">A DOM element within which a matching element may be found. If no ctx is passed in then the ctx of the jQuery set will be used instead.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>For each element in the set, get the first element that matches the selector by testing the element itself and traversing up through its ancestors in the DOM tree.</summary>
  ...
  'context': function() {
    /// <summary>The DOM node ctx originally passed to jQuery(); if none was passed then ctx will likely be the document.</summary>
    /// <returns type="Element" />
  },
  'css': function() {
    /// <signature>
  ...
  'init': function() {
    ...
    ///   <param name="ctx" type="jQuery">A DOM Element, Document, or jQuery to use as ctx</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Accepts a string containing a CSS selector which is then used to match a set of elements.</summary>
