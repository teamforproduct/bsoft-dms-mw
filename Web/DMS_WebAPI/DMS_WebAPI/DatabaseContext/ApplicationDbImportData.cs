...
namespace DMS_WebAPI.Models
{
    public static class ApplicationDbImportData
    {
        ...
        public static List<AdminLanguageValues> GetAdminLanguageValuesForActions()
        {
            ...
            AddALV(list, "##l@AdminActions:AddRoleAction@l##", "Add role action", "Добавить действие для роли", "Додати дію для ролі");
            AddALV(list, "##l@AdminActions:DeleteRoleAction@l##", "Delete role action", "Удалить действие для роли", "Видалити дію для ролі");
            AddALV(list, "##l@AdminActions:AddPositionRole@l##", "Add position role", "Добавить роль для должности", "Додати роль для посади");
            AddALV(list, "##l@AdminActions:ModifyPositionRole@l##", "Modify position role", "Изменить роль для должности", "Змінити роль для посади");
            AddALV(list, "##l@AdminActions:DeletePositionRole@l##", "Delete position role", "Удалить роль для должности", "Видалити роль для посади");
            AddALV(list, "##l@AdminActions:DuplicatePositionRoles@l##", "Duplicate position roles", "Дублировать роли должности", "Дублювати ролі посади");
            AddALV(list, "##l@AdminActions:AddUserRole@l##", "Add user role", "Добавить роль для пользователя", "Додати роль для користувача");
            AddALV(list, "##l@AdminActions:ModifyUserRole@l##", "Modify user role", "Изменить роль для пользователя", "Змінити роль для користувача");
            AddALV(list, "##l@AdminActions:DeleteUserRole@l##", "Delete user role", "Удалить роль для пользователя", "Видалити роль для користувача");
            ...
            AddALV(list, "##l@AdminActions:SetSubordinationByCompany@l##", "Set subordination by company", "Управление правилами рассылки", "Управління правилами розсилки");
            AddALV(list, "##l@AdminActions:SetSubordinationByDepartment@l##", "Set subordination by department", "Управление правилами рассылки", "Управління правилами розсилки");
            AddALV(list, "##l@AdminActions:SetDefaultSubordination@l##", "Set default subordination", "Управление правилами рассылки", "Управління правилами розсилки");
            AddALV(list, "##l@AdminActions:DuplicateSubordinations@l##", "Duplicate subordinations", "Управление правилами рассылки", "Управління правилами розсилки");
            AddALV(list, "##l@AdminActions:SetAllSubordination@l##", "Allow all subordinations", "Разрешить рассылку без ограничений", "Дозволити розсилку без обмежень");
