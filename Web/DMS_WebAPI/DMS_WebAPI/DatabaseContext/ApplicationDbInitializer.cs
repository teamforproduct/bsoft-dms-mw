...
namespace DMS_WebAPI.Models
{
    public class ApplicationDbInitializer : CreateDatabaseIfNotExists<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            context.AdminLanguagesSet.AddRange(DmsDbImportData.GetAdminLanguages().Select(
                x=> new AdminLanguages() {
                    Id = x.Id,
                    Code = x.Code,
                    Name = x.Name,
            ...
            context.AdminLanguageValuesSet.AddRange(DmsDbImportData.GetAdminLanguageValues().Select(
                x => new AdminLanguageValues()
                {
                    Id = x.Id,
